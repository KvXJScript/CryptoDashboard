      ...
      <header className="sticky top-0 z-50 glass-card border-b border-border/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Button
              onClick={handleLogin}
              className="bg-crypto-primary hover:bg-crypto-primary/90 text-white shadow-lg hover:shadow-crypto-primary/25 transition-all duration-300"
            >
              Sign In
            </Button>
          </div>
        ...
        <div className="text-center">
          ...
          <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            <Button
              size="lg"
              onClick={handleLogin}
              className="bg-gradient-to-r from-crypto-primary to-crypto-success hover:from-crypto-primary/90 hover:to-crypto-success/90 text-white px-8 py-3 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Get Started Free
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="px-8 py-3 text-lg border-crypto-primary text-crypto-primary hover:bg-crypto-primary hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              Learn More
            </Button>
          </div>
